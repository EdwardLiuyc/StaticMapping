...
set_target_properties(GeographicLib::GeographicLib_SHARED PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libGeographic.so.19.0.1"
  IMPORTED_SONAME_RELEASE "libGeographic.so.19"
  )

list(APPEND _IMPORT_CHECK_TARGETS GeographicLib::GeographicLib_SHARED )
list(APPEND _IMPORT_CHECK_FILES_FOR_GeographicLib::GeographicLib_SHARED "${_IMPORT_PREFIX}/lib/libGeographic.so.19.0.1" )
